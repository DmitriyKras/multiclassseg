...
class UNetHead(nn.Module):
    def __init__(self, n_classes: int, config=[[32, False, 320, 112],
                               [16, False, 112, 40],
                               [8, False, 40, 24]]):
        ...
        self.conv = nn.Conv2d(config[-1][-1], n_classes, 1)
...
class EfficientUnet(nn.Module):
    def __init__(self, n_classes: int, model_type='efficientnet-b0'):
